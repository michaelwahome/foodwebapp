        ...
        <div class="account">
            <?php
                ...
                if ($result->num_rows > 0) {
                    echo "<table class='table' style='width: 100%; text-align: left;'><tr><th>Username</th><th>First Name</th><th>Last Name</th><th>Email</th><th>Phone Number</th><th>Password</th><th>Edit</th><th>Delete</th></tr>";
                ...
                for($page = 1; $page<= $number_of_pages; $page++) {  
                    echo "<a style='margin: 1em; font-weight: bold;' href = 'useraccounts.php?page=" . $page . "'>Page " . $page . " </a>";  
                }  
